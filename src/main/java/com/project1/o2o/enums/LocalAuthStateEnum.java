...
public enum LocalAuthStateEnum {
	LOGINFAIL(-1, "wrong password or username"), SUCCESS(0, "success"),NULL_AUTH_INFO(-1006, "empty account information"),
	ONLY_ONE_ACCOUNT(-1007, "each wechat can only bind one account");
